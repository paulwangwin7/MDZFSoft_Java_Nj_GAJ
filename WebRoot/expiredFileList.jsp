...
<form id="fileDelForm" name="fileDelForm" action="" method="post">
							<table class="Js_grayBg common_table file_table">
								...
								<tr>
									...
									<td class="textc" style="display:none"><%=file.getFileStats().equals("0")?"普通":"重要★" %></td>
								...
								<tr>
									<td class="pr textc" colspan="10">
										<input type="button" style="display:none" class="blue_mod_btn" onclick="fileDel()" value="删除普通" />
										<input type="button" style="display:none" class="blue_mod_btn" onclick="fileDel2()" value="删除重要" />
										<input type="button" class="blue_mod_btn" onclick="fileDel()" value="删 除" />
									</td>
								</tr>
							</table>
</form>
